...
const validarPassword2 = () => {
    ...
    if(inputPassword1.value !== inputPassword2.value ) {
        ...
        document.querySelector('#grupo__password2 i').classList.add('bi-clipboard-x-fill')
        ...
        document.querySelector('#grupo__password2 i').classList.remove('bi-clipboard-x-fill')
...
const validarCampo = (expresion, input, campo) => {
    if (expresion.test(input.value)){
        ...
        document.querySelector(`#grupo__${campo} i`).classList.remove('bi-clipboard-x-fill')
        ...
        document.querySelector(`#grupo__${campo} i`).classList.add('bi-clipboard-x-fill')
